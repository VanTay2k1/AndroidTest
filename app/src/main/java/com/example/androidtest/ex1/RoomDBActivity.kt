...
class RoomDBActivity : AppCompatActivity() {
    ...
    private suspend fun addData() {
        val studentDao = database.studentDao()
        studentDao.insert(Student(name = "John Doe1", age = 20, address = "1233 Street"))
        studentDao.insert(Student(name = "John Doe2", age = 20, address = "1253 Street"))
        studentDao.insert(Student(name = "John Doe3", age = 20, address = "1263 Street"))
        studentDao.insert(Student(name = "John Doe4", age = 20, address = "1273 Street"))
    }
}
